...
export function extractADSDataFromApplication(app) {
  ...
  return {
    ...
    applicationType: meta.filing_type || 'provisional',
...
function labelValue(doc, label, value, x, y, labelWidth = 140) {
  doc.setFontSize(8)
  doc.setFont('helvetica', 'normal')
...
export function generateADSForm(data) {
