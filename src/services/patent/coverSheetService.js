// src/services/patent/coverSheetService.js
...
function drawBox(doc, x, y, w, h, fill = false) {
  if (fill) {
...
export function generateSB16PDF(data) {
...
export function validateCoverSheetData(data) {
  const errors = []
...
export function createDefaultInventor() {
  return {
...
export function createDefaultCorrespondenceAddress() {
  return {
    name: '',
    street: '',
    city: '',
...
export function downloadCoverSheet(data) {
...
export function generateCoverSheetHTML(data) {
...
export function generateCoverSheetPDF(data) {
...
export function generateSB17PDF(data) {
  const doc = new jsPDF({ orientation: 'portrait', unit: 'pt', format: 'letter' })
  let y = MARGIN
...
export function downloadFeeTransmittal(data) {
